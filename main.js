window.datetime = (function() {
    ...
    var dt = class extends Date {
        ...
        strftime(string, locale=language) {
            var a = {
                y: this.getFullYear(),
                m: this.getMonth() + 1,
                d: this.getDate(),
    ...
    dt.prototype.newLocale = function(dict) {
        Object.assign(this.locale, dict);
    }
    
    dt.prototype.setLocale = function(loc) {
        language = loc;
    }
